...
export function LandingNavbar() {
  return (
    <nav className="fixed top-2 sm:top-6 left-2 sm:left-6 right-2 sm:right-6 z-50 flex items-center justify-center pointer-events-none">
      <div className="mx-auto flex h-12 sm:h-14 w-full max-w-7xl items-center justify-between px-4 sm:px-6 pointer-events-auto rounded-[1rem] sm:rounded-[1.25rem] border border-white/5 bg-black/40 backdrop-blur-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
        <div className="flex items-center gap-3">
          ...
          <span className="text-base sm:text-lg font-black tracking-tighter text-white">ScrumCollab</span>
        </div>
